...
public class ServicioCaminos {
    ...
    /**
     * Método caminos
     * El método es una adaptación del recorrido dfs, debido a que se trata de descubrir todos los caminos posibles y
     * no, por ejemplo, el de menor longitud (para lo que habría sido adecuado la adaptación de un recorrido bfs).
     *
     * Complejidad: O (V + A) donde V es la cantidad de vértices y A es la cantidad de arcos del grafo.
     * En el peor de los casos, cuando el límite de arcos pasado por parámetro sea excesivo,
     * deberán recorrerse todos los vértices y todos los arcos. En el caso contrario, cuando el límite sea igual a 0,
     * no se realizará ningún recorrido. De modo tal que el factor decisivo en el cálculo de la complejidad de este
     * método es el límite de arcos que restringe la cantidad de arcos por los que se podrá pasar.
     *
     * @return List<List<Integer>> Lista de listas de vértices -caminos- que cumplen la restricción de límite de arcos
